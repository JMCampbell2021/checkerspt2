...
var pieces = []; // starting position of the red checker pieces
...
function Checkersboard() {
  var checkerboardRef = react_1.useRef(null); // Movement of the Pieces

  var activePiece = null; // grab piece
  ...
  var _loop_1 = function _loop_1(j) {
    var _loop_2 = function _loop_2(i) {
      ...
      board.push(react_1["default"].createElement(Tile_1["default"], {
        key: j + "," + i,
        image: image,
        number: number
      }));
